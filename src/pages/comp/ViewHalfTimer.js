...
const ViewHalfTimer = ({route}) => {
  ...
  const fetchdata = async () => {
    try {
      const response = await axios.get(`${url}/half-day-student/${id}/${idt}/`,{
        headers: {
  ...
  const deleteData = async () => {
    try {
      await axios.delete(`${url}/half-day-student/${id}/${idt}/`, {
        headers: {
          Authorization: 'Bearer ' + String(user.access),
        },
      });
  ...
  const patchData = async () => {
    try {
       await axios.patch(`${url}/half-day-student/${id}/${idt}/`,updateData, {
        headers: {
